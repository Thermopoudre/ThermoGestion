    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <section className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl font-black mb-4">Roadmap ThermoGestion</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-12">
          ...
          return (
            <section key={section.status}>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="px-2 py-0.5 bg-gray-200 dark:bg-gray-700 rounded-full text-sm text-gray-600 dark:text-gray-400">
                  {section.items.length}
                </span>
              </div>
              <div className="grid md:grid-cols-2 gap-4">
                {section.items.map(item => (
                  <div key={item.title} className="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow">
        ...
        <section className="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-2xl p-8 text-center">
          <h3 className="text-xl font-bold mb-2">Une idée de fonctionnalité ?</h3>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Vos retours orientent notre développement. Partagez vos besoins !
          </p>
          <a href="/app/feedback" className="inline-flex items-center gap-2 px-6 py-3 bg-orange-500 text-white rounded-lg hover:bg-orange-600 font-bold">
